...
exports.createAsset = async (req, res, next) => {
  try {
    const { project } = req.params;
    const { assetName, roadType } = req.body;
    ...
    const assets = await surveyLibraryService.createAsset(project, assetName, roadType, videoFile, vttFile, req.user);
...
exports.updateAsset = async (req, res, next) => {
  try {
    ...
    const assets = await surveyLibraryService.updateAsset(project, assetId, assetName, roadType, videoFile, vttFile, req.user);
