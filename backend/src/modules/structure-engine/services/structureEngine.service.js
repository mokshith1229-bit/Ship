...
const STRUCTURE_QUESTION_DEFINITIONS = {
  'WEARING_COAT_DECK_SLAB': { code: 'WEARING_COAT_DECK_SLAB', question: 'Wearing coat on deck slab', category: 'Structures', placement: 'ALL_POINTS' },
  ...
  'RIGID_CRASH_BARRIERS': { code: 'RIGID_CRASH_BARRIERS', question: 'Rigid crash barriers', category: 'Structures', placement: 'ALL_POINTS' },
...
const STRUCTURE_QUESTION_CONFIG = {
  'BC': [
    STRUCTURE_QUESTION_DEFINITIONS['WEARING_COAT_DECK_SLAB'],
    STRUCTURE_QUESTION_DEFINITIONS['RIGID_CRASH_BARRIERS'],
